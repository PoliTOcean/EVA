...
from PyInstaller.utils.hooks.qt import \
    add_qt5_dependencies, get_qt_webengine_binaries_and_data_files, pyside2_library_info
...
if pyside2_library_info.version is not None:
    ...
    webengine_binaries, webengine_datas = get_qt_webengine_binaries_and_data_files(pyside2_library_info)

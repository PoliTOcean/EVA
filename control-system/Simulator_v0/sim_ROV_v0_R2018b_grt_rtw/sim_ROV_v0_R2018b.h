...
struct B_sim_ROV_v0_R2018b_T {
  ...
  B_LowpassFilter_sim_ROV_v0_R2_T LowpassFilter5;/* '<S30>/Lowpass Filter' */
  B_LowpassFilter_sim_ROV_v0_R2_T LowpassFilter4;/* '<S30>/Lowpass Filter' */
  B_LowpassFilter_sim_ROV_v0_R2_T LowpassFilter3;/* '<S30>/Lowpass Filter' */
...
struct DW_sim_ROV_v0_R2018b_T {
  ...
  boolean_T IntegratorSecondOrderLimited_DW;
                                  /* '<S53>/Integrator, Second-Order Limited' */
  boolean_T IntegratorSecondOrderLimited__i;
                                  /* '<S41>/Integrator, Second-Order Limited' */
  DW_LowpassFilter_sim_ROV_v0_R_T LowpassFilter5;/* '<S30>/Lowpass Filter' */
  DW_LowpassFilter_sim_ROV_v0_R_T LowpassFilter4;/* '<S30>/Lowpass Filter' */
  DW_LowpassFilter_sim_ROV_v0_R_T LowpassFilter3;/* '<S30>/Lowpass Filter' */
